...
- [Edge/WAF та rate limiting](content/Edge-WAF-та-rate-limiting.md): де фільтрувати масований IP-трафік і чим це відрізняється від application rate limiting.
...
- [MEDIUM-3: відсутній rate limiting](content/Безпековий-аудит-MEDIUM-3-rate-limiting.md): локальні ліміти для login, registration і password reset реалізовані, а shared storage та edge/WAF залишаються в роботі.
